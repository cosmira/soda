...
final class MaxEfferentCoupling extends ExpressionCheck
{
    /**
    ...
    {
        return sprintf('class where efferent_coupling > %d', $this->limit);
    }
    ...
    protected function violation(FileFacts $file, array $row): Violation
    {
        return new Violation(
            rule: $this->id(),
            file: $file->path,
            value: (int) $row['efferent_coupling'],
