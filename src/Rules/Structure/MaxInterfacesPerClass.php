...
final class MaxInterfacesPerClass extends ExpressionCheck
{
    /**
    ...
    {
        return 'max_interfaces_per_class';
    }
    ...
    {
        return sprintf('class where interfaces > %d', $this->limit);
    }
