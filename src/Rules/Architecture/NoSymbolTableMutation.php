...
final class NoSymbolTableMutation extends Check
{
    /**
    ...
    public function checkFile(FileFacts $file): iterable
    {
        ...
        foreach ($nodes as $node) {
            yield new Violation(
                ...
                message: 'Symbol-table mutation hides data flow. Read named fields or map input into a typed object explicitly.',
            );
        }
    }
    ...
    {
        return 'no_symbol_table_mutation';
    }
