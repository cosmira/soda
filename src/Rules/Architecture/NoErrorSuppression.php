...
final class NoErrorSuppression extends Check
{
    /**
    ...
    {
        $nodes = (new NodeFinder)->find($file->nodes, fn (Node $node): bool => $node instanceof Expr\ErrorSuppress);
        ...
        foreach ($nodes as $node) {
            yield new Violation(
                ...
                message: 'Error suppression hides failures. Handle or translate the failure explicitly.',
            );
        }
    }
