...
final readonly class MultilinePropertyPhpDoc implements RuleChecker
{
    /**
    ...
    private function config(): QualityConfig
    {
        return new QualityConfig(
            rules: [MultilinePhpDocChecker::PROPERTY_RULE => $this->maxViolations],
            ruleState: new QualityConfigRuleState(options: [
                MultilinePhpDocChecker::PROPERTY_RULE => ['visibilities' => $this->visibilities],
            ]),
        );
    }
}
